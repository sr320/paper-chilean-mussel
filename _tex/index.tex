...
2025). As shown in Figure~\ref{fig-study-locations} and detailed in
Table~\ref{tbl-env-comparison}, these two seedbeds exhibit contrasting
environmental conditions, including differences in water temperature,
salinity, depth, and aquaculture intensity that may contribute to the
observed population-level adaptations.

\phantomsection\label{cell-fig-study-locations}
\begin{figure}[H]

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-study-locations-1.pdf}}

}

\caption{\label{fig-study-locations}Map showing the study locations
Cochamó (41°S) and Yaldad (43°S) in the inner sea of Chiloé Island,
Chile. The map highlights key environmental differences between these
contrasting seedbeds, including variations in water depth, temperature,
salinity, and aquaculture intensity that may contribute to
population-level adaptation in Mytilus chilensis.}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.4161}}
  >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3504}}@{}}
...
\phantomsection\label{cell-fig-dml-chromosome}
\begin{figure}[H]

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-dml-chromosome-1.pdf}}

}

\caption{\label{fig-dml-chromosome}Distribution of differentially
methylated loci (DMLs) across chromosomes. Each bar represents the count
of DMLs for a specific chromosome, with colors indicating whether loci
are hypermethylated (higher in Yaldad) or hypomethylated (lower in
Yaldad).}
...
\subsection{Chromosome-wide Distribution of
DMLs}\label{chromosome-wide-distribution-of-dmls}

To visualize the spatial distribution of differentially methylated loci
across the genome, we created a comprehensive plot showing all
chromosomes and the precise locations of DMLs within each chromosome.
This visualization reveals the genomic landscape of epigenetic variation
and identifies potential hotspots of methylation change.

\phantomsection\label{cell-fig-dml-genome-wide}
\begin{figure}[H]

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-dml-genome-wide-1.pdf}}

}

\caption{\label{fig-dml-genome-wide}Distribution of differentially
methylated loci (DMLs) across all chromosomes. Each point represents a
DML positioned by its genomic coordinates. Red points indicate
hypermethylated loci (higher methylation in Yaldad), while blue points
show hypomethylated loci (lower methylation in Yaldad). Chromosomes are
arranged vertically with genomic position (in base pairs) on the
x-axis.}
